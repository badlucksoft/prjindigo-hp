...
if(strcmp(THE_URI,LOGIN_URI) == 0) {
	...
	if( strcmp(THE_URI, '/') != 0 && preg_match('#^\/(.*(\.(jpg|gif|png|svg|htm|html|mp4|wav|mpg|mp3|css|js|txt|avi|mov|ico))?)$#i',THE_URI,$match) > 0 && strcmp(basename(THE_URI),basename(HOMEPAGE_CONTENT_FILENAME)) != 0 )
	{
